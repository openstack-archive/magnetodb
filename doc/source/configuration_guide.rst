...
`````````
 ...
 - log_rotation: enables application log rotation
 - log_max_size: maximum log size after it will be rotated, no rotation if 0
 - log_backup_count: maximum count of rotating log files, no rotation if 0
