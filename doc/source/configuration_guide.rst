...
cluster_handler:
 ...
 - kwargs: <keyword arguments map for object initialization>
    ...
    - concurrent_queries - max count of started but not completed CLQ queries
...
storage_manager:
 ...
 - kwargs: <keyword arguments map for object initialization>
    ...
    - concurrent_tasks - current of started but not completed storage_driver methods invocations
    - batch_chunk_size - used for splitting original batch to chunks. It is needed because large batches may impact Cassandra latency for another concurrent queries
