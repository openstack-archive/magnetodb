...
from contrib.tempest.cli import output_parser
...
class ClientTestBase(test.BaseTestCase):
    ...
    def magnetodb(self, action, flags='', params='', admin=True,
                  fail_ok=False):
        """Executes magnetodb command for the given action."""
        return self.cmd_with_auth(
            'magnetodb', action, flags, params, admin, fail_ok)
