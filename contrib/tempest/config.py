...
from contrib.tempest.common.utils.misc import singleton
...
ServiceAvailableGroup = [
    ...
    # TODO Added by yyekovenko
    cfg.BoolOpt('magnetodb',
                default=True,
                help="Whether or not MagnetoDB is expected to be available"),
]
...
class TempestConfig:
    ...
    def __init__(self):
        ...
        register_opt_group(cfg.CONF, magnetodb_streaming_group,
                           MagnetoDBStreamingGroup)
        register_opt_group(cfg.CONF, magnetodb_monitoring_group,
                           MagnetoDBMonitoringGroup)
        register_opt_group(cfg.CONF, magnetodb_management_group,
                           MagnetoDBManagementGroup)
