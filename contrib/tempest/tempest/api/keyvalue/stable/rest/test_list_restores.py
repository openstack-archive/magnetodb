...
class MagnetoDBListRestoresTest(MagnetoDBTestCase):
    ...
    def test_list_restore_jobs(self):
        ...
        headers, body = self.management_client.list_restore_jobs(
            self.tname, last_evaluated_restore_job_id=last_eval_id, limit=2)
        ...
        self.assertTrue(buuid1 in buuids)
        self.assertTrue(buuid2 in buuids)
        self.assertTrue(buuid3 in buuids)
