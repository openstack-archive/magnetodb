...
from contrib.tempest.common.utils import data_utils
...
class MagnetoDBTestCase(test.BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.os, cls.os_alt = cls.get_client_manager()
        ...
        cls.management_client.get_auth()
        if cls.os_alt:
            ...
            cls.management_client = cls.os_alt.magnetodb_management_client
            cls.management_client.get_auth()
