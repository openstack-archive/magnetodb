...
from contrib.tempest import clients
from contrib.tempest.common.utils.file_utils import have_effective_read_access
from contrib.tempest import config as cfg
from contrib.tempest import exceptions
from contrib.tempest.openstack.common import log as logging
from contrib.tempest import test
from contrib.tempest.api.keyvalue.boto_base.utils.wait import re_search_wait
from contrib.tempest.api.keyvalue.boto_base.utils.wait import state_wait
from contrib.tempest.api.keyvalue.boto_base.utils.wait import wait_exception
...
class BotoTestCase(test.BaseTestCase):
    ...
    def assertAddressReleasedWait(self, address):
        ...
        def _address_delete():
            ...
            if (address.public_ip not in map(
                    lambda a: a.public_ip,
