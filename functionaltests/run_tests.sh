...
tox -e all tempest.api.keyvalue.stable.rest.test_list_table.MagnetoDBListTableTestCase.test_list_tables_exclusive_3_symb -- --parallel --concurrency=1 2>&1 | tee $LOGS_DIR/tempest-stable.txt
RETVAL=${PIPESTATUS[0]}
