...
echo 'CREATE TABLE magnetodb.table_info(tenant text, name text, exists int, "schema" text, status text, internal_name text, last_updated float, PRIMARY KEY(tenant,name));' >> ~/.ccm/cql.txt
