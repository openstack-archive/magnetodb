...
class ClusterHandler(object):
    def __init__(self, cluster_params, query_timeout=2,  concurrent_queries=100):
        ...
        self.__cluster = None
        self.__session = None
        self.__connection_monitor_thread = Thread(target=self.__monitor_control_connection)
