...
__all__ = ['setup',
           ...
           'EVENT_TYPE_DATA_GETITEM',
           'EVENT_TYPE_DATA_GETITEM_START',
           'EVENT_TYPE_DATA_GETITEM_END',
           'EVENT_TYPE_DATA_QUERY',
           'EVENT_TYPE_DATA_QUERY_START',
           'EVENT_TYPE_DATA_QUERY_END',
...
EVENT_TYPE_TABLE_CREATE_START = nsu.EVENT_TYPE_TABLE_CREATE_START
EVENT_TYPE_TABLE_CREATE_END = nsu.EVENT_TYPE_TABLE_CREATE_END
EVENT_TYPE_TABLE_CREATE_ERROR = nsu.EVENT_TYPE_TABLE_CREATE_ERROR
EVENT_TYPE_TABLE_DELETE_START = nsu.EVENT_TYPE_TABLE_DELETE_START
EVENT_TYPE_TABLE_DELETE_END = nsu.EVENT_TYPE_TABLE_DELETE_END
EVENT_TYPE_TABLE_DELETE_ERROR = nsu.EVENT_TYPE_TABLE_DELETE_ERROR
EVENT_TYPE_TABLE_DESCRIBE = nsu.EVENT_TYPE_TABLE_DESCRIBE
EVENT_TYPE_TABLE_LIST = nsu.EVENT_TYPE_TABLE_LIST
EVENT_TYPE_DATA_PUTITEM = nsu.EVENT_TYPE_TABLE_LIST
EVENT_TYPE_DATA_PUTITEM_START = nsu.EVENT_TYPE_DATA_PUTITEM_START
EVENT_TYPE_DATA_PUTITEM_END = nsu.EVENT_TYPE_DATA_PUTITEM_END
EVENT_TYPE_DATA_DELETEITEM = nsu.EVENT_TYPE_DATA_DELETEITEM
EVENT_TYPE_DATA_DELETEITEM_START = nsu.EVENT_TYPE_DATA_DELETEITEM_START
EVENT_TYPE_DATA_DELETEITEM_END = nsu.EVENT_TYPE_DATA_DELETEITEM_END
EVENT_TYPE_DATA_DELETEITEM_ERROR = nsu.EVENT_TYPE_DATA_DELETEITEM_ERROR
EVENT_TYPE_DATA_BATCHWRITE_START = nsu.EVENT_TYPE_DATA_BATCHWRITE_START
EVENT_TYPE_DATA_BATCHWRITE_END = nsu.EVENT_TYPE_DATA_BATCHWRITE_END
EVENT_TYPE_DATA_BATCHREAD_START = nsu.EVENT_TYPE_DATA_BATCHREAD_START
EVENT_TYPE_DATA_BATCHREAD_END = nsu.EVENT_TYPE_DATA_BATCHREAD_END
EVENT_TYPE_DATA_UPDATEITEM = nsu.EVENT_TYPE_DATA_UPDATEITEM
EVENT_TYPE_DATA_GETITEM = nsu.EVENT_TYPE_DATA_GETITEM
EVENT_TYPE_DATA_GETITEM_START = nsu.EVENT_TYPE_DATA_GETITEM_START
EVENT_TYPE_DATA_GETITEM_END = nsu.EVENT_TYPE_DATA_GETITEM_END
EVENT_TYPE_DATA_QUERY = nsu.EVENT_TYPE_DATA_QUERY
EVENT_TYPE_DATA_QUERY_START = nsu.EVENT_TYPE_DATA_QUERY_START
EVENT_TYPE_DATA_QUERY_END = nsu.EVENT_TYPE_DATA_QUERY_END
EVENT_TYPE_DATA_SCAN_START = nsu.EVENT_TYPE_DATA_SCAN_START
EVENT_TYPE_DATA_SCAN_END = nsu.EVENT_TYPE_DATA_SCAN_END
