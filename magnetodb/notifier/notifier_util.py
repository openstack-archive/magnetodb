...
EVENT_TYPE_REQUEST_TIMING_ERROR = EVENT_TYPE_REQUEST_TIMING + ERROR_SUFFIX
...
EVENT_TYPE_TABLE_CREATE_ERROR = EVENT_TYPE_TABLE_CREATE + ERROR_SUFFIX

EVENT_TYPE_TABLE_DELETE = 'magnetodb.table.delete'
EVENT_TYPE_TABLE_DELETE_ERROR = EVENT_TYPE_TABLE_DELETE + ERROR_SUFFIX
...
EVENT_TYPE_DYNAMO_TABLE_LIST_ERROR = (EVENT_TYPE_DYNAMO_TABLE_LIST +
                                      ERROR_SUFFIX)

EVENT_TYPE_REQUEST_PUTITEM = 'magnetodb.req.mdb.PutItem'
EVENT_TYPE_REQUEST_PUTITEM_ERROR = EVENT_TYPE_REQUEST_PUTITEM + ERROR_SUFFIX
EVENT_TYPE_DYNAMO_PUTITEM = 'magnetodb.req.ddb.PutItem'
EVENT_TYPE_DYNAMO_PUTITEM_ERROR = EVENT_TYPE_DYNAMO_PUTITEM + ERROR_SUFFIX
...
EVENT_TYPE_DYNAMO_DELETEITEM_ERROR = (EVENT_TYPE_DYNAMO_DELETEITEM +
                                      ERROR_SUFFIX)

EVENT_TYPE_REQUEST_BATCHREAD = 'magnetodb.req.mdb.BatchRead'
EVENT_TYPE_REQUEST_BATCHREAD_ERROR = (EVENT_TYPE_REQUEST_BATCHREAD +
                                      ERROR_SUFFIX)
EVENT_TYPE_DYNAMO_BATCHREAD = 'magnetodb.req.ddb.BatchRead'
EVENT_TYPE_DYNAMO_BATCHREAD_ERROR = EVENT_TYPE_DYNAMO_BATCHREAD + ERROR_SUFFIX
...
EVENT_TYPE_DYNAMO_BATCHWRITE_ERROR = (EVENT_TYPE_DYNAMO_BATCHWRITE +
                                      ERROR_SUFFIX)
...
EVENT_TYPE_DYNAMO_UPDATEITEM_ERROR = (EVENT_TYPE_DYNAMO_UPDATEITEM +
                                      ERROR_SUFFIX)

EVENT_TYPE_REQUEST_GETITEM = 'magnetodb.req.mdb.GetItem'
EVENT_TYPE_REQUEST_GETITEM_ERROR = EVENT_TYPE_REQUEST_GETITEM + ERROR_SUFFIX
EVENT_TYPE_DYNAMO_GETITEM = 'magnetodb.req.ddb.GetItem'
EVENT_TYPE_DYNAMO_GETITEM_ERROR = EVENT_TYPE_DYNAMO_GETITEM + ERROR_SUFFIX

EVENT_TYPE_REQUEST_QUERY = 'magnetodb.req.mdb.Query'
EVENT_TYPE_REQUEST_QUERY_ERROR = EVENT_TYPE_REQUEST_QUERY + ERROR_SUFFIX
EVENT_TYPE_DYNAMO_QUERY = 'magnetodb.req.ddb.Query'
EVENT_TYPE_DYNAMO_QUERY_ERROR = EVENT_TYPE_DYNAMO_QUERY + ERROR_SUFFIX

EVENT_TYPE_REQUEST_SCAN = 'magnetodb.req.mdb.Scan'
EVENT_TYPE_REQUEST_SCAN_ERROR = EVENT_TYPE_REQUEST_SCAN + ERROR_SUFFIX
EVENT_TYPE_DYNAMO_SCAN = 'magnetodb.req.ddb.Scan'
EVENT_TYPE_DYNAMO_SCAN_ERROR = EVENT_TYPE_DYNAMO_SCAN + ERROR_SUFFIX
