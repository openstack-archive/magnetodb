...
class CreateTableTest(test_base_testcase.APITestCase):
    ...
    def test_create_table_invalid_name_character(self):
        ...
        expected_error = {
            'message': "Wrong table name 'Thread Table' found",
            'traceback': None,
            'type': 'ValidationError',
        }
    ...
    def test_create_table_invalid_name_limit(self):
        ...
        expected_error = {
            'message': "Wrong table name 'Th' found",
            'traceback': None,
            'type': 'ValidationError',
        }
    ...
    def test_create_table_index_invalid_name_character(self):
        ...
        expected_error = {
            'message': "Wrong index name 'Last Post Index' found",
            'traceback': None,
            'type': 'ValidationError',
        }
    ...
    def test_create_table_index_invalid_name_limit(self):
        ...
        expected_error = {
            'message': "Wrong index name 'LP' found",
            'traceback': None,
            'type': 'ValidationError',
        }
