...
class SimpleStorageManagerTestCase(unittest.TestCase):
    ...
    def test_update_status_on_describe_for_creating_table(
        ...
        table_info = TableInfo(table_name, None, TableMeta.TABLE_STATUS_CREATING)
        ...
        self.assertEqual(table_meta.status, TableMeta.TABLE_STATUS_CREATE_FAILED)
    ...
    def test_update_status_on_describe_for_creating_table_negative(
        ...
        self.assertEqual(table_meta.status, TableMeta.TABLE_STATUS_CREATING)
    ...
    def test_update_status_on_describe_for_deleting_table(
        ...
        table_info = TableInfo(table_name, None, TableMeta.TABLE_STATUS_DELETING)
        table_info.last_updated = 0
        ...
        self.assertEqual(table_meta.status, TableMeta.TABLE_STATUS_DELETE_FAILED)
