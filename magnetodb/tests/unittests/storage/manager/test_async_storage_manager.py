...
from magnetodb.storage.manager.async_impl import AsyncStorageManager
...
class AsyncStorageManagerTestCase(unittest.TestCase):
    ...
    def test_create_table_async(self, mock_table_info_repo):
        ...
        storage_manager = AsyncStorageManager(mock_storage_driver,
        ...
        # TableInfo status should be creating
        self.assertEqual("creating", table_info_save_args_list[0][0][1].status)
        ...
        self.assertEqual("active", table_info_update_args_list[0][0][1].status)
