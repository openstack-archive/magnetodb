...
from magnetodb.storage.driver.cassandra import cassandra_impl as impl
from magnetodb.storage.driver.cassandra.cassandra_impl import \
    CassandraStorageDriver
...
class TestCassandraBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        storage_driver = CassandraStorageDriver(cluster_hadler,
                                                table_info_repo)
