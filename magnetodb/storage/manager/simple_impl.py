...
class SimpleStorageManager(StorageManager):
    ...
    def _validate_table_schema(self, table_name, attribute_map,
                               keys_only=True):
        table_info = self._table_info_repo.get(table_name)
        ...
        if keys_only:
            ...
            if len(schema_key_attributes) != len(key_attribute_map):
                ...
                for schema_key_attr_name in schema_key_attributes:
                    ...
                    if (key_attribute is None or
                            schema_attribute_type_map[key_attribute] !=
            ...
            for schema_key_attr_name in schema_key_attributes:
                ...
                if key_attribute is None:
                    ...
                    if (schema_attribute_type_map[key_attribute] !=
                            key_attribute.arrt_type):
                        table_schema_is_valid = False
    ...
    def put_item(self, context, put_request, if_not_exist=False,
        ...
        self._validate_table_schema(
            put_request.table_name, put_request.attribute_map, False)
    ...
    def delete_item(self, context, delete_request,
                    expected_condition_map=None):
        self._validate_table_schema(delete_request.table_name,
    ...
    def execute_get_batch(self, context, read_request_list):
        ...
        for req in read_request_list:
            ...
            self._validate_table_schema(table_name, key_attributes)
    ...
    def update_item(self, context, table_name, key_attribute_map,
        ...
        self._validate_table_schema(table_name, key_attribute_map)
        with self.__task_semaphore:
