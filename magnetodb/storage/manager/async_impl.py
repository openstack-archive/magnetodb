...
class AsyncStorageManager(SimpleStorageManager):
    ...
    def create_table(self, context, table_name, table_schema):
        return self._create_table_async(context, table_name, table_schema)

    def delete_table(self, context, table_name):
        return self._delete_table_async(context, table_name)

    def _create_table_async(self, context, table_name, table_schema):
    ...
    def _delete_table_async(self, context, table_name):
