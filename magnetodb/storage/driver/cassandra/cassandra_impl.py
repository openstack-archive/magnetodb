...
class CassandraStorageDriver(StorageDriver):
    ...
    def table_usage_details(self, context, table_info):
        ...
        :returns: count of items in table and table size in bytes
