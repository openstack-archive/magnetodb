...
class CassandraStorageDriver(StorageDriver):
    ...
    def _put_item_if_not_exists(self, table_info, attribute_map):
        ...
        result = self.__cluster_handler.execute_query(put_query, consistent=True)
    ...
    def put_item(self, context, put_request, if_not_exist=False,
        ...
        table_info = self.__table_info_repo.get(context, put_request.table_name)
        ...
        if if_not_exist:
            ...
            while True:
                ...
                result = self.__cluster_handler.execute_query(put_request, consistent=True)
    ...
    def _select_current_index_values(
        ...
        select_result = self.__cluster_handler.execute_query(select_query, consistent=False)
    ...
    def delete_item(self, context, delete_request,
        ...
        table_info = self.__table_info_repo.get(context, delete_request.table_name)
        ...
        if table_info.schema.index_def_map:
            while True:
                ...
                result = self.__cluster_handler.execute_query(delete_query, consistent=True)
    ...
    def update_item(self, context, table_name, key_attribute_map,
        ...
        if table_info.schema.index_def_map:
            ...
            while True:
                ...
                result = self.__cluster_handler.execute_query(update_query, consistent=True)
