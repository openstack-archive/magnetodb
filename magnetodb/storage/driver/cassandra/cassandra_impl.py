...
class CassandraStorageDriver(StorageDriver):
        ...
        if table_info.schema.index_def_map:
            ...
            for attr_name, attr_action in (
                ...
                if attr_action.action in (
                    ...
                    attribute_map[attr_name] = self._delete_attr(
    ...
    def _delete_attr(self, context, table_name, attr_name, attr_value,
                     key_attribute_map, expected_condition_map):
        ...
        # Update condition_map to garantee consistensy
        expected_condition_map[attr_name] = [
            models.ExpectedCondition.eq(item[attr_name])
        ]

        return models.AttributeValue(item[attr_name].type,
