...
class CassandraStorageDriver(StorageDriver):
    ...
    @probe.probe_notify(__name__ + '.create_table')
    ...
    @probe.probe_notify(__name__ + '.delete_table')
    ...
    @probe.probe_notify(__name__ + '.put_item')
    ...
    @probe.probe_notify(__name__ + '.delete_item')
    ...
    @probe.probe_notify(__name__ + '.update_item')
    ...
    @probe.probe_notify(__name__ + '.select_item')
    ...
    @probe.probe_notify(__name__ + '.scan')
