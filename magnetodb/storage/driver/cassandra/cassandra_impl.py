...
class CassandraStorageDriver(StorageDriver):
    ...
    @probe.probe(__name__ + '.create_table')
    ...
    @probe.probe(__name__ + '.delete_table')
    ...
    @probe.probe(__name__ + '.delete_item')
    ...
    @probe.probe(__name__ + '.update_item')
    ...
    @probe.probe(__name__ + '.select_item')
