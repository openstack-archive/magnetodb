...
class CassandraBackupInfoRepository(BackupInfoRepository):
    ...
    __field_list = (
        'tenant_table', 'id', 'name', 'table_name', 'status',
        'start_date_time', 'finish_date_time', 'location', 'strategy'
    )
    ...
    def save(self, context, table_name, backup_info):
        ...
        query_builder.append(
            " WHERE tenant_name='{}' AND id='{}'".format(
    ...
    def get(self, context, table_name, backup_id):
        ...
        query_builder.append(
            " FROM {} WHERE tenant_name='{}' AND id='{}'".format(
