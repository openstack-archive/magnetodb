...
from magnetodb.storage.backup_info_repo.cassandra_impl import (
    CassandraBackupInfoRepository)


class BackupManager(object):

    def __init__(self):
        self.backup_info_repo = CassandraBackupInfoRepository(None)
    ...
    def create_backup(self, context, table_name, backup_name, strategy):
        ...
        backup_info = BackupInfo(
            ...
            status=BackupInfo.BACKUP_STATUS_CREATING,
            location='default location',
            strategy=strategy,
            start_date_time=datetime.datetime.now())

        return self.backup_info_repo.save(context, table_name, backup_info)
