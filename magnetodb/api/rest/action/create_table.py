...
from magnetodb.api.rest.action import MagnetoDBAction
...
class CreateTableRestAction(MagnetoDBAction):
    schema = {
    ...
    def __call__(self):
        ...
        try:
            ...
            url = self.context.path_url + "/" + table_name
            bookmark = self.context.path_url + "/" + table_name
