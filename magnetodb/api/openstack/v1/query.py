...
class QueryController(object):
    ...
    def query(self, req, body, project_id, table_name):
        ...
        order_asc = body.pop(parser.Props.SCAN_INDEX_FORWARD, True)
        validation.validate_boolean(order_asc, parser.Props.SCAN_INDEX_FORWARD)

        validation.validate_unexpected_props(body, "request body")
        order_type = (
            models.ORDER_TYPE_ASC if order_asc else models.ORDER_TYPE_DESC
        )
