...
class MagnetoDBApplication(wsgi.Router):
    ...
    def __init__(self):
        ...
        mapper.connect(
            "delete_item", "/{project_id}/data/tables/{table_name}/delete_item",
            conditions={'method': 'POST'},
            controller=create_resource(delete_item.DeleteItemController()),
            action="process_request"
        ),
        mapper.connect(
            "update_item", "/{project_id}/data/tables/{table_name}/update_item",
            conditions={'method': 'POST'},
        ...
        mapper.connect(
            ...
            conditions={'method': 'GET'},
            controller=create_resource(describe_table.DescribeTableController()),
