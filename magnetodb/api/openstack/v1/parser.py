...
class Values():
    ...
    SPECIFIC_ATTRIBUTES = models.SelectType.SELECT_TYPE_SPECIFIED
...
ATTRIBUTE_NAME_PATTERN = models.NAME_PATTERN
TABLE_NAME_PATTERN = models.NAME_PATTERN
INDEX_NAME_PATTERN = models.NAME_PATTERN
...
class Parser():
    ...
    def decode_attr_value(cls, dynamodb_attr_type, dynamodb_attr_value):
        ...
        return AttributeValue(attr_type, encoded_value=dynamodb_attr_value)

    @classmethod
    def encode_attr_value(cls, attr_value):
        return {
            cls.STORAGE_TO_DYNAMODB_TYPE_MAP[
                attr_value.type
    ...
    def parse_select_type(cls, select, attributes_to_get,
        ...
        return models.SelectType(select, attributes_to_get)
    ...
    @classmethod
    def parse_request_items(cls, request_items_container_json):
        request_items_json = request_items_container_json[Props.REQUEST_ITEMS]
                    ...
                    if request_type == Props.REQUEST_PUT:
                        result.append(
                            models.PutItemRequest(
                                table_name, cls.parse_item_attributes(
