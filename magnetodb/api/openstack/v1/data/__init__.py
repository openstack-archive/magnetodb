...
class TablesController(rest.RestController):
    ...
    def put_item(self, project_id, table_name):
        return put_item.put_item(pecan.request, project_id, table_name)

    @pecan.expose("json")
    def get_item(self, project_id, table_name):
...
class MagnetoDBRootController(rest.RestController):
    ...
    @pecan.expose("json")
    def batch_write_item(self, project_id):
        return batch_write_item.batch_write_item(
            pecan.request, project_id
        )

    @pecan.expose("json")
    def batch_get_item(self, project_id):
