...
def bulk_load_app(environ, start_response):
    ...
    if not re.match("^/v1/\w+/data/tables/\w+/bulk_load$", path):
        ...
        _notifier.error(
            ctxt,
            _notifier.EVENT_TYPE_STREAMING_PATH_ERROR,
            {'path': path})
        return
    ...
    _notifier.info(
        ctxt,
        _notifier.EVENT_TYPE_STREAMING_DATA_START,
        {'path': path})
    ...
    while True:
        ...
        try:
            ...
            _notifier.error(
                ctxt,
                _notifier.EVENT_TYPE_STREAMING_DATA_ERROR,
    ...
    _notifier.info(
        ctxt, _notifier.EVENT_TYPE_STREAMING_DATA_END,
