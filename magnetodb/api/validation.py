...
# http://www.datastax.com/documentation/cql/3.1/cql/cql_reference\
#       /\valid_literal_r.html
ATTRIBUTE_NAME_PATTERN = re.compile("^\w{1,255}$")
TABLE_NAME_PATTERN = re.compile("^\w{3,255}$")
