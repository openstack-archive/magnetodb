...
class MagnetoDBQueriesTest(MagnetoDBTestCase):
    ...
    def test_query_key_cond_b(self):
        ...
        key_conditions = {
            'forum': {
                'attribute_value_list': [{'B': '00000001'}],
                'comparison_operator': 'EQ'
            }
        }
        headers, body = self.client.query(table_name=self.tname,
    ...
    def test_query_one_key_cond_le_b_01(self):
        self._query_key_cond_comparison('B', '00000001', '00000010', 'LE', 1)

    def test_query_one_key_cond_le_b_02(self):
        self._query_key_cond_comparison('B', '00000001', '00000001', 'LE', 1)

    def test_query_one_key_cond_le_b_03(self):
        self._query_key_cond_comparison('B', '00000001', '00000000', 'LE', 0)

    def test_query_one_key_cond_lt_b_01(self):
        self._query_key_cond_comparison('B', '00000001', '00000010', 'LT', 1)

    def test_query_one_key_cond_lt_b_02(self):
        self._query_key_cond_comparison('B', '00000001', '00000001', 'LT', 0)

    def test_query_one_key_cond_lt_b_03(self):
        self._query_key_cond_comparison('B', '00000001', '00000000', 'LT', 0)

    def test_query_one_key_cond_ge_b_01(self):
        self._query_key_cond_comparison('B', '00000001', '00000010', 'GE', 0)

    def test_query_one_key_cond_ge_b_02(self):
        self._query_key_cond_comparison('B', '00000001', '00000001', 'GE', 1)

    def test_query_one_key_cond_ge_b_03(self):
        self._query_key_cond_comparison('B', '00000001', '00000000', 'GE', 1)

    def test_query_one_key_cond_gt_b_01(self):
        self._query_key_cond_comparison('B', '00000001', '00000010', 'GT', 0)

    def test_query_one_key_cond_gt_b_02(self):
        self._query_key_cond_comparison('B', '00000001', '00000001', 'GT', 0)

    def test_query_one_key_cond_gt_b_03(self):
        self._query_key_cond_comparison('B', '00000001', '00000000', 'GT', 1)
