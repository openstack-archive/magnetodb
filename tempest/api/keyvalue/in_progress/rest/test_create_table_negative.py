...
class MagnetoDBCreateTableNegativeTestCase(MagnetoDBTestCase):
    ...
    @test.attr(type=['CreT-8.1', 'negative'])
    ...
    @test.attr(type=['CreT-8.2', 'negative'])
    ...
    @test.attr(type=['CreT-8.3', 'CreT-34', 'negative'])
    ...
    @test.attr(type=['CreT-8.4', 'negative'])
    ...
    @test.attr(type=['CreT-8.5', 'negative'])
    ...
    @test.attr(type=['CreT-8.6', 'negative'])
    ...
    @test.attr(type=['CreT-8.7', 'negative'])
    ...
    @test.attr(type=['CreT-20.1', 'negative'])
    ...
    @test.attr(type=['CreT-20.2', 'negative'])
    ...
    @test.attr(type=['CreT-36.1', 'negative'])
    ...
    @test.attr(type=['CreT-36.2', 'negative'])
    ...
    @test.attr(type=['CreT-32.1', 'negative'])
    ...
    @test.attr(type=['CreT-32.2', 'negative'])
    ...
    @test.attr(type=['CreT-53.1', 'negative'])
    ...
    @test.attr(type=['CreT-53.2', 'negative'])
    ...
    @test.attr(type=['CreT-53.3', 'negative'])
    ...
    @test.attr(type=['CreT-84.1', 'negative'])
    ...
    @test.attr(type=['CreT-84.2', 'negative'])
